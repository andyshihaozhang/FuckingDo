...
using FuckingDo.Effects;
using FuckingDo.ViewModels.Pages.ScriptExecutor;
using Wpf.Ui;

namespace FuckingDo.Views.Pages.ScriptExecutor;

public partial class ScriptExecutorPage : INavigableView<ScriptExecutorViewModel>
{
    private readonly INavigationService _navigationService;
    private SnowflakeEffect? _snowflake;

    public ScriptExecutorViewModel ViewModel { get; }

    public ScriptExecutorPage(ScriptExecutorViewModel viewModel, INavigationService navigationService)
    {
        ViewModel = viewModel;
        DataContext = this;
